...
RSpec.describe DataPresenter do
  describe "#trip_data_for_map" do
    before do
      trip = FactoryBot.build(:trip, number_of_rides: 0)
      ...
      trip.save!
      trip_2 = FactoryBot.build(:trip, number_of_rides: 0)
      ...
      trip_2.save!
      trip_3 = FactoryBot.build(:trip, number_of_rides: 0)
